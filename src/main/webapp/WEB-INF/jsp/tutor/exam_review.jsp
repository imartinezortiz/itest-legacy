...
<div id="menu">
  <ul>
	...
	<li> <a style="border: ridge; background-color:#CCCCCC; color:#000000;" href="${pageContext.request.contextPath}/tutor/managegroup.itest?method=showStudentExam&alu=${user.id}&exam=${exam.id}&reGrade=true"><fmt:message key="buttonCorrectExam" /></a> </li>
    <li> <a style="border: ridge; background-color:#CCCCCC; color:#000000;" href="javascript:window.close();"><fmt:message key="closeButton" /></a> </li>
  </ul>
</div>
...
<div id="contenido">
	...
	<div id="calif" class="respuestasTipoTest">
	   <p align="center"><b><fmt:message key="yourcalif" />&nbsp;<fmt_rt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${exam.examGrade}"/></legend></p>
	   <hr/>
	</div>
